            ...
            <div className="flex-1 overflow-y-auto p-6 space-y-4">
              {cart.length === 0 ? (
                <div className="h-full flex flex-col items-center justify-center text-center p-8 text-[#64748B]">
                  ...
                  <h4 className="text-sm font-bold text-[#1E293B]">Your Borrow Bag is Empty</h4>
                    ...
                    >
                      ...
                      <div className="flex items-center justify-between pt-2 border-t border-[#E2E8F0]/60 text-xs">
                        ...
                        <select
                          ...
                          className="text-xs font-bold text-[#0F172A] bg-white border border-[#CBD5E1] rounded-lg px-2 py-1 focus:outline-none cursor-pointer"
                        >
              ...
              <form onSubmit={handleSubmit} className="p-6 bg-[#F8FAFC] border-t border-[#E2E8F0] space-y-4">
                <div>
                  ...
                  <input
                    ...
                    className="w-full text-xs px-3.5 py-2.5 bg-white border border-[#CBD5E1] rounded-xl focus:outline-none focus:ring-2 focus:ring-[#2D6A4F]/30 focus:border-[#2D6A4F] text-[#0F172A]"
                  />
                </div>
                ...
                <div className="bg-white p-3 rounded-xl border border-[#E2E8F0] text-xs text-[#64748B] space-y-1">
                  ...
                  <div className="flex justify-between">
                    ...
                    <strong className="text-[#0F172A]">{currentUser?.grade}</strong>
                  </div>
                </div>
