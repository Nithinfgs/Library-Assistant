    ...
    <AnimatePresence>
      ...
      >
        <button
          ...
          className="group relative flex items-center gap-3 px-5 py-3.5 bg-[#1F2933] hover:bg-[#0F172A] text-white rounded-full shadow-2xl hover:shadow-[#2D6A4F]/30 transition-all duration-200 cursor-pointer border border-white/10"
        >
          <div className="relative">
            <ShoppingBag className="w-5 h-5 text-[#2D6A4F] group-hover:scale-110 transition-transform" />
            {cart.length > 0 && (
