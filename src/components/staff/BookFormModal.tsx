...
export const BookFormModal: React.FC<BookFormModalProps> = ({
  ...
  const [coverColor, setCoverColor] = useState('#0E7490');
  ...
  useEffect(() => {
    if (book) {
      ...
      setCoverColor(book.coverColor || '#1E293B');
  ...
  return (
    <AnimatePresence>
      <div className="fixed inset-0 z-50 flex items-center justify-center p-4 bg-black/50 backdrop-blur-xs overflow-y-auto">
        ...
        >
          {/* Header */}
          <div className="p-6 bg-[#1F2933] text-white flex items-center justify-between">
            <div className="flex items-center gap-3">
              <div className="p-2.5 rounded-xl bg-white/10 text-white">
                <BookPlus className="w-5 h-5 text-[#2D6A4F]" />
              </div>
              <div>
          ...
          <form onSubmit={handleSubmit} className="p-6 space-y-4 max-h-[75vh] overflow-y-auto">
            ...
            <div className="grid grid-cols-2 gap-4">
              <div>
                ...
                <select
                  ...
                  className="w-full text-xs sm:text-sm font-semibold px-3.5 py-2.5 bg-[#F8FAFC] border border-[#CBD5E1] rounded-xl focus:bg-white focus:outline-none text-[#0F172A] cursor-pointer"
                >
            ...
            <div className="grid grid-cols-2 gap-4">
              <div>
                ...
                <input
                  ...
                  className="w-full text-xs px-3.5 py-2.5 bg-[#F8FAFC] border border-[#CBD5E1] rounded-xl focus:bg-white focus:outline-none text-[#0F172A]"
                  required
                />
              </div>
            ...
            <div className="grid grid-cols-2 gap-4 bg-[#F8FAFC] p-3.5 rounded-2xl border border-[#E2E8F0]">
              <div>
                ...
                <input
                  ...
                  className="w-full text-xs px-3 py-2 bg-white border border-[#CBD5E1] rounded-xl focus:outline-none text-[#0F172A]"
                />
              </div>
            ...
            <div className="grid grid-cols-3 gap-3">
              <div>
                ...
                <input
                  ...
                  className="w-full text-xs font-bold px-3 py-2 bg-[#F8FAFC] border border-[#CBD5E1] rounded-xl focus:outline-none text-[#0F172A]"
                  required
                />
              </div>
            ...
            <div>
              ...
              <textarea
                ...
                className="w-full text-xs sm:text-sm p-3 bg-[#F8FAFC] border border-[#CBD5E1] rounded-xl focus:bg-white focus:outline-none text-[#0F172A]"
                required
              />
            </div>
            ...
            <div className="pt-3">
              <button
                type="submit"
                className="w-full flex items-center justify-center gap-2 py-3 bg-[#2D6A4F] hover:bg-[#22543D] active:scale-[0.99] text-white text-xs sm:text-sm font-extrabold rounded-xl shadow-lg shadow-[#2D6A4F]/20 transition-all cursor-pointer"
              >
