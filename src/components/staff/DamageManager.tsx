      ...
      <div className="space-y-4">
        {damageLogs.length === 0 ? (
          <div className="bg-white rounded-3xl border border-[#E2E8F0] p-12 text-center text-[#64748B]">
            ...
            <h3 className="text-sm font-bold text-[#0F172A]">No Damaged Books Logged</h3>
              ...
              >
                ...
                <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-3 pt-2 text-xs">
                  <span className="text-[#64748B]">
                    Action Taken: <strong className="text-[#0F172A]">{log.actionTaken}</strong>
                  </span>
                  ...
                  <div className="flex items-center gap-2">
                    ...
                    <select
                      ...
                      className="bg-[#F8FAFC] border border-[#CBD5E1] rounded-lg px-2 py-1 font-bold text-[#0F172A] focus:outline-none cursor-pointer"
                    >
