    ...
    <div className="min-h-screen bg-[#F8F9FA] flex flex-col justify-between font-sans">
      <div>
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8 space-y-6">
          ...
          <div className="bg-gradient-to-r from-[#1F2933] to-[#0F172A] text-white rounded-3xl p-6 sm:p-8 shadow-xl border border-white/10 flex flex-col lg:flex-row items-start lg:items-center justify-between gap-6">
            <div className="space-y-3">
              <div className="inline-flex items-center gap-2 px-3 py-1 rounded-full bg-white/10 text-xs font-bold text-[#68D391]">
              ...
              <div className="flex flex-wrap items-center gap-2.5 pt-2">
                <button
                  ...
                  className="flex items-center gap-2 px-4 py-2 bg-[#2D6A4F] hover:bg-[#22543D] active:scale-[0.98] text-white text-xs font-bold rounded-xl shadow-md shadow-[#2D6A4F]/30 transition-all cursor-pointer"
                >
                  <FileSpreadsheet className="w-4 h-4 text-[#A7F3D0]" />
            ...
            <div className="grid grid-cols-2 sm:grid-cols-4 gap-3 bg-white/5 p-4 rounded-2xl border border-white/10 w-full lg:w-auto">
              ...
              <div className="text-center px-2 border-l border-white/10">
                ...
                <span className="text-lg font-black text-[#68D391]">{loans.filter((l) => l.status !== 'returned').length}</span>
              </div>
              <div className="text-center px-2 border-l border-white/10">
          ...
          <div className="flex flex-col sm:flex-row items-start sm:items-center justify-between gap-4 pb-2">
            <div className="flex items-center gap-2 bg-[#F1F5F9] p-1.5 rounded-2xl border border-[#E2E8F0] overflow-x-auto no-scrollbar max-w-full">
              ...
              >
                <BookPlus className="w-4 h-4 text-[#BE123C]" />
