      ...
      <div className="bg-white p-4 rounded-3xl border border-[#E2E8F0] shadow-sm flex flex-col md:flex-row items-center justify-between gap-4">
        ...
        <div className="flex items-center gap-2.5 w-full md:w-auto justify-end flex-wrap">
          ...
          <div className="flex items-center bg-[#F8FAFC] border border-[#CBD5E1] rounded-xl p-1 text-xs">
            <button
              ...
              className={`px-3 py-1 rounded-lg font-bold transition-all cursor-pointer ${
                collectionFilter === 'all' ? 'bg-white text-[#0F172A] shadow-xs' : 'text-[#64748B]'
              }`}
            >
              All ({books.length})
            </button>
            <button
              ...
              className={`px-3 py-1 rounded-lg font-bold transition-all cursor-pointer ${
                collectionFilter === 'academic' ? 'bg-white text-[#0F172A] shadow-xs' : 'text-[#64748B]'
              }`}
            >
              Academic
            </button>
            <button
              ...
              className={`px-3 py-1 rounded-lg font-bold transition-all cursor-pointer ${
                collectionFilter === 'fiction' ? 'bg-white text-[#0F172A] shadow-xs' : 'text-[#64748B]'
              }`}
            >
              Fiction
            </button>
          ...
          <button
            ...
            className="flex items-center gap-1.5 px-4 py-2 bg-[#2D6A4F] hover:bg-[#22543D] text-white text-xs font-bold rounded-xl shadow-md transition-all cursor-pointer"
          >
                ...
                return (
                  <tr key={book.id} className="hover:bg-[#F8FAFC] transition-colors">
                    ...
                    <td className="px-5 py-4">
                      <div className="font-extrabold text-[#0F172A] line-clamp-1 max-w-xs">
                        {book.title}
                      </div>
                    ...
                    <td className="px-5 py-4">
                      ...
                      <div className="text-[10px] font-mono text-[#0F172A] font-bold mt-0.5">
                    ...
                    <td className="px-5 py-4 text-right whitespace-nowrap">
                      <div className="flex items-center justify-end gap-1.5">
                        ...
                        <button
                          ...
                          className="p-1.5 text-[#475569] hover:text-[#0F172A] hover:bg-[#F1F5F9] rounded-lg transition-colors cursor-pointer"
