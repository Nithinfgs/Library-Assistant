      ...
      <div className="bg-white p-4 rounded-3xl border border-[#E2E8F0] shadow-sm flex flex-col sm:flex-row items-center justify-between gap-4">
        ...
        <div className="flex items-center gap-2 w-full sm:w-auto justify-end">
          ...
          <button
            ...
            className="flex items-center gap-1.5 px-3.5 py-1.5 bg-[#2D6A4F] hover:bg-[#22543D] text-white text-xs font-bold rounded-xl shadow-xs transition-colors cursor-pointer whitespace-nowrap"
                        ...
                        {loan.status !== 'returned' ? (
                          <div className="flex items-center justify-end gap-2">
                            ...
                            <button
                              ...
                              className="px-3.5 py-1.5 bg-[#2D6A4F] hover:bg-[#22543D] text-white font-bold rounded-xl shadow-xs transition-all cursor-pointer"
                            >
                              Check In & Return
                            </button>
                          </div>
