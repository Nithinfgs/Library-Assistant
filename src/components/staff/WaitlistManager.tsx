              ...
              >
                ...
                <div className="p-5 bg-[#F8FAFC] border-b border-[#E2E8F0] flex flex-col sm:flex-row sm:items-center justify-between gap-3">
                  <div className="flex items-center gap-3">
                    <div 
                      ...
                      style={{ backgroundColor: matchedBook?.coverColor || '#1E293B' }}
                    >
                    ...
                    <div>
                      ...
                      <p className="text-[10px] text-[#94A3B8] font-mono">
                        Call #: {matchedBook?.location.callNumber || 'N/A'} • Available Copies: <strong className={matchedBook?.availableCopies === 0 ? 'text-[#DC2626]' : 'text-[#2D6A4F]'}>{matchedBook?.availableCopies || 0} of {matchedBook?.totalCopies || 0}</strong>
                      </p>
                    </div>
                  </div>
                ...
                <div className="divide-y divide-[#F1F5F9]">
                  {entries.map((entry) => (
                    ...
                    >
                      <div className="flex items-center gap-3">
                        <div className="w-8 h-8 rounded-full bg-[#1F2933] text-white flex items-center justify-center font-extrabold text-xs">
                          #{entry.queuePosition}
                        </div>
                        <div>
                      ...
                      <div className="flex items-center gap-2 self-end sm:self-center">
                        <button
                          ...
                          className="flex items-center gap-1 px-3 py-1.5 bg-[#EEF2FF] hover:bg-[#E0E7FF] text-[#4338CA] text-xs font-bold rounded-xl transition-colors cursor-pointer"
                        >
