      ...
      <div className="bg-white p-4 rounded-3xl border border-[#E2E8F0] shadow-sm flex flex-col sm:flex-row items-center justify-between gap-4">
        <div className="relative w-full sm:max-w-md">
          ...
          <input
            ...
            className="w-full pl-9 pr-4 py-2 text-xs bg-[#F8FAFC] border border-[#CBD5E1] rounded-xl focus:bg-white focus:outline-none focus:ring-2 focus:ring-[#2D6A4F]/30 text-[#0F172A]"
          />
        </div>
        ...
        <div className="flex items-center gap-2">
          <select
            ...
            className="text-xs font-bold bg-[#F8FAFC] border border-[#CBD5E1] rounded-xl px-3 py-2 text-[#0F172A] focus:outline-none cursor-pointer"
          >
      ...
      <div className="space-y-4">
        {filtered.length === 0 ? (
          <div className="bg-white rounded-3xl border border-[#E2E8F0] p-12 text-center text-[#64748B]">
            ...
            <h3 className="text-sm font-bold text-[#0F172A]">No Acquisition Requests</h3>
                ...
                <div className="flex flex-col sm:flex-row sm:items-start justify-between gap-3">
                  <div className="space-y-1">
                    ...
                    <p className="text-[11px] text-[#94A3B8]">
                      Requested by <strong className="text-[#0F172A]">{req.studentName}</strong> ({req.studentGrade}) on {new Date(req.createdAt).toLocaleDateString('en-US', { month: 'short', day: 'numeric', year: 'numeric' })}
                    </p>
                  </div>
                ...
                <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-3 pt-2 border-t border-[#F1F5F9]">
                  <div className="flex-1 max-w-md">
                    <input
                      ...
                      className="w-full text-xs px-3 py-1.5 bg-[#F8FAFC] border border-[#CBD5E1] rounded-xl focus:bg-white text-[#0F172A]"
                    />
                  </div>
                  ...
                  <div className="flex items-center gap-1.5 flex-wrap">
                    <button
                      ...
                      className="px-3 py-1.5 bg-[#EEF2FF] hover:bg-[#E0E7FF] text-[#4338CA] text-xs font-bold rounded-xl transition-colors cursor-pointer"
                    >
                      Approve
                    </button>
                    ...
                    <button
                      ...
                      className="px-3.5 py-1.5 bg-[#2D6A4F] hover:bg-[#22543D] text-white text-xs font-bold rounded-xl transition-colors cursor-pointer"
                    >
                      Arrived & Cataloged
                    </button>
