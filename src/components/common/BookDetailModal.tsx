          ...
          <div className="p-6 space-y-6 max-h-[70vh] overflow-y-auto">
            ...
            <div className="bg-[#F8FAFC] p-4 rounded-2xl border border-[#E2E8F0] flex flex-col sm:flex-row items-start sm:items-center justify-between gap-4">
              <div className="flex items-start gap-3">
                <div className="p-2.5 rounded-xl bg-[#2D6A4F]/10 text-[#2D6A4F] mt-0.5">
                ...
                {isOutOfStock ? (
                  ...
                  <>
                    ...
                    <button
                      ...
                      className="flex-1 sm:flex-none flex items-center justify-center gap-2 px-5 py-2.5 bg-[#2D6A4F] hover:bg-[#22543D] text-white text-xs sm:text-sm font-bold rounded-xl shadow-lg shadow-[#2D6A4F]/20 transition-all cursor-pointer"
                    >
