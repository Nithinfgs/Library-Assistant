      ...
      <div>
        <div className="flex items-start gap-4">
          ...
          <div className="flex-1 min-w-0">
            ...
            <h3 className="text-sm font-extrabold text-[#0F172A] leading-tight line-clamp-2 group-hover:text-[#2D6A4F] transition-colors">
              {book.title}
            </h3>
          ...
          {isOutOfStock ? (
            ...
            <>
              <button
                ...
                className="flex-1 flex items-center justify-center gap-1.5 py-2 px-3 bg-[#2D6A4F] hover:bg-[#22543D] text-white text-xs font-bold rounded-xl transition-all shadow-xs cursor-pointer"
              >
