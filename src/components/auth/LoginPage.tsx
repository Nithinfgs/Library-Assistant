...
export const LoginPage: React.FC = () => {
  ...
  return (
    <div className="min-h-screen bg-[#F8F9FA] flex flex-col justify-center py-12 sm:px-6 lg:px-8 font-sans relative overflow-hidden">
      ...
      <div className="absolute top-0 -left-40 w-96 h-96 bg-[#2D6A4F]/10 rounded-full blur-3xl pointer-events-none" />
      <div className="absolute bottom-0 -right-40 w-96 h-96 bg-[#4338CA]/10 rounded-full blur-3xl pointer-events-none" />

      <div className="sm:mx-auto sm:w-full sm:max-w-md text-center space-y-3 relative z-10">
        {/* Brand Icon */}
        <div className="w-16 h-16 rounded-3xl bg-[#1F2933] text-white flex items-center justify-center mx-auto shadow-xl ring-4 ring-[#2D6A4F]/20">
      ...
      <div className="mt-8 sm:mx-auto sm:w-full sm:max-w-md px-4 sm:px-0 relative z-10">
        <div className="bg-white py-8 px-6 sm:px-10 rounded-3xl border border-[#E2E8F0] shadow-xl space-y-6">
          ...
          <div className="p-3.5 bg-[#F8FAFC] border border-[#E2E8F0] rounded-2xl space-y-2">
            <div className="flex items-center gap-1.5 text-[#0F172A] text-xs font-bold">
            ...
            <div className="grid grid-cols-2 gap-2">
              <button
                ...
                className="px-3 py-2 bg-white hover:bg-[#2D6A4F] hover:text-white text-[#0F172A] border border-[#CBD5E1] rounded-xl text-xs font-bold transition-all shadow-xs flex items-center justify-center gap-1.5 cursor-pointer"
              >
              ...
              <button
                ...
                className="px-3 py-2 bg-white hover:bg-[#1F2933] hover:text-white text-[#0F172A] border border-[#CBD5E1] rounded-xl text-xs font-bold transition-all shadow-xs flex items-center justify-center gap-1.5 cursor-pointer"
              >
            ...
            >
              <div>
                ...
                <div className="relative">
                  ...
                  <input
                    ...
                    className="w-full pl-9 pr-4 py-2.5 text-xs sm:text-sm font-semibold bg-[#F8FAFC] border border-[#CBD5E1] rounded-xl focus:bg-white focus:outline-none focus:ring-2 focus:ring-[#2D6A4F]/30 text-[#0F172A]"
                    required
                  />
                </div>
              </div>
              ...
              <div>
                ...
                <input
                  ...
                  className="w-full text-xs sm:text-sm font-semibold px-3.5 py-2.5 bg-[#F8FAFC] border border-[#CBD5E1] rounded-xl focus:bg-white focus:outline-none focus:ring-2 focus:ring-[#2D6A4F]/30 text-[#0F172A]"
                  required
                />
              </div>
              ...
              <div className="pt-2">
                <button
                  type="submit"
                  className="w-full flex items-center justify-center gap-2 py-3 bg-[#2D6A4F] hover:bg-[#22543D] active:scale-[0.99] text-white text-xs sm:text-sm font-extrabold rounded-xl shadow-lg shadow-[#2D6A4F]/25 transition-all cursor-pointer"
                >
          ...
          {activeTab === 'staff' && (
            ...
            >
              <div>
                ...
                <div className="relative">
                  ...
                  <input
                    ...
                    className="w-full pl-9 pr-4 py-2.5 text-xs sm:text-sm font-semibold bg-[#F8FAFC] border border-[#CBD5E1] rounded-xl focus:bg-white focus:outline-none focus:ring-2 focus:ring-[#4338CA]/30 text-[#0F172A]"
                    required
                  />
                </div>
              </div>
              ...
              <div className="bg-[#EEF2FF] p-3 rounded-xl border border-[#C7D2FE] text-xs text-[#4338CA] space-y-1">
              ...
              <div className="pt-2">
                <button
                  type="submit"
                  className="w-full flex items-center justify-center gap-2 py-3 bg-[#4338CA] hover:bg-[#3730A3] active:scale-[0.99] text-white text-xs sm:text-sm font-extrabold rounded-xl shadow-lg shadow-[#4338CA]/25 transition-all cursor-pointer"
                >
        ...
        <div className="mt-8 grid grid-cols-2 gap-3 text-center">
          <div className="p-3 bg-white rounded-2xl border border-[#E2E8F0] shadow-xs">
            <GraduationCap className="w-4 h-4 text-[#4338CA] mx-auto mb-1" />
            <p className="text-[11px] font-bold text-[#0F172A]">Academic & DP Texts</p>
            <p className="text-[10px] text-[#64748B]">Chem, Phys, Math, Bio</p>
          </div>
          <div className="p-3 bg-white rounded-2xl border border-[#E2E8F0] shadow-xs">
            <Sparkles className="w-4 h-4 text-[#BE123C] mx-auto mb-1" />
            <p className="text-[11px] font-bold text-[#0F172A]">Fiction & Non-Fiction</p>
            <p className="text-[10px] text-[#64748B]">Series Part 1-5 & Sagas</p>
          </div>
          <div className="p-3 bg-white rounded-2xl border border-[#E2E8F0] shadow-xs">
            <Clock className="w-4 h-4 text-[#B45309] mx-auto mb-1" />
            <p className="text-[11px] font-bold text-[#0F172A]">Reading Journey Log</p>
            <p className="text-[10px] text-[#64748B]">Minutes & Deadlines</p>
          </div>
          <div className="p-3 bg-white rounded-2xl border border-[#E2E8F0] shadow-xs">
            <Hourglass className="w-4 h-4 text-[#2D6A4F] mx-auto mb-1" />
            <p className="text-[11px] font-bold text-[#0F172A]">Waitlist Priority</p>
