  ...
  return (
    <div className="space-y-8 max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-6 font-sans">
      ...
      <div className="grid grid-cols-2 lg:grid-cols-4 gap-4">
        ...
        <div className="bg-white p-5 rounded-3xl border border-[#E2E8F0] shadow-sm flex items-center gap-4">
          <div className="p-3.5 rounded-2xl bg-[#2D6A4F]/10 text-[#2D6A4F]">
        ...
        <div className="bg-white p-5 rounded-3xl border border-[#E2E8F0] shadow-sm flex items-center gap-4">
          <div className="p-3.5 rounded-2xl bg-[#4338CA]/10 text-[#4338CA]">
      ...
      <div className="space-y-4">
        ...
        {activeLoans.length === 0 ? (
          <div className="bg-white rounded-3xl border border-[#E2E8F0] p-10 text-center">
            ...
            <h3 className="text-sm font-bold text-[#0F172A]">No Books Currently Checked Out</h3>
                ...
                >
                  ...
                  <div className="flex items-start justify-between gap-4">
                    <div className="flex items-start gap-3.5">
                      <div
                        ...
                        style={{ backgroundColor: loan.coverColor || '#1E293B' }}
                      >
                      ...
                      <div>
                        ...
                        <h3 className="text-sm font-extrabold text-[#0F172A] leading-tight line-clamp-1">
                          {loan.bookTitle}
                        </h3>
                        <p className="text-xs text-[#64748B]">
                          By {loan.bookAuthor}
                  ...
                  <div className="bg-[#F8FAFC] p-3.5 rounded-2xl border border-[#E2E8F0] space-y-2">
                    ...
                    <p className="text-[11px] text-[#94A3B8]">
                      Due Date: <strong className="text-[#0F172A]">{new Date(loan.dueDate).toLocaleDateString('en-US', { weekday: 'short', month: 'short', day: 'numeric', year: 'numeric' })}</strong>
                    </p>
                  </div>
                  ...
                  <div className="flex items-center gap-2 pt-2 border-t border-[#F1F5F9]">
                    ...
                    <button
                      ...
                      className="py-2 px-3 bg-[#EBF5EE] hover:bg-[#D4EDDA] text-[#2D6A4F] text-xs font-bold rounded-xl transition-colors cursor-pointer"
              ...
              <div key={log.id} className="p-5 flex flex-col sm:flex-row sm:items-start justify-between gap-4">
                <div className="space-y-1.5">
                  <div className="flex items-center gap-2">
                    ...
                    {log.completedBook && (
                      <span className="text-[10px] font-extrabold bg-[#EBF5EE] text-[#2D6A4F] px-2 py-0.5 rounded-full border border-[#2D6A4F]/20">
                        🎉 Completed
                      </span>
                    )}
                  </div>
                  ...
                  <p className="text-xs text-[#64748B]">
                    Read <strong className="text-[#0F172A]">{log.minutesRead} mins</strong> • Pages {log.startPage} to {log.endPage} (of {log.totalPages})
                  </p>
