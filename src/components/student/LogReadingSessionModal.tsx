          ...
          <form onSubmit={handleSubmit} className="p-6 space-y-4">
            ...
            <div>
              ...
              <select
                ...
                className="w-full text-xs sm:text-sm font-semibold px-3.5 py-2.5 bg-[#F8FAFC] border border-[#CBD5E1] rounded-xl focus:bg-white focus:outline-none focus:ring-2 focus:ring-[#B45309]/30 focus:border-[#B45309] text-[#0F172A] cursor-pointer"
              >
                {activeLoans.map((l) => (
            ...
            <div className="grid grid-cols-2 gap-4">
              <div>
                ...
                <div className="relative">
                  ...
                  <input
                    ...
                    className="w-full pl-9 pr-3 py-2 text-xs sm:text-sm font-bold bg-[#F8FAFC] border border-[#CBD5E1] rounded-xl focus:bg-white focus:outline-none focus:ring-2 focus:ring-[#B45309]/30 text-[#0F172A]"
                    required
                  />
                </div>
              </div>
              ...
              <div>
                ...
                <input
                  ...
                  className="w-full px-3 py-2 text-xs sm:text-sm font-bold bg-[#F8FAFC] border border-[#CBD5E1] rounded-xl focus:bg-white focus:outline-none focus:ring-2 focus:ring-[#B45309]/30 text-[#0F172A]"
                  required
                />
              </div>
            </div>
            ...
            <div className="grid grid-cols-2 gap-4">
              <div>
                ...
                <input
                  ...
                  className="w-full px-3 py-2 text-xs sm:text-sm font-bold bg-[#F8FAFC] border border-[#CBD5E1] rounded-xl focus:bg-white focus:outline-none text-[#0F172A]"
                  required
                />
              </div>
            ...
            <div>
              ...
              <textarea
                ...
                className="w-full text-xs sm:text-sm p-3 bg-[#F8FAFC] border border-[#CBD5E1] rounded-xl focus:bg-white focus:outline-none focus:ring-2 focus:ring-[#B45309]/30 text-[#0F172A]"
              />
            </div>
            ...
            <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-3 pt-2">
              ...
              <label className="flex items-center gap-2 cursor-pointer text-xs font-bold text-[#0F172A]">
                <input
                  ...
                  className="w-4 h-4 text-[#2D6A4F] rounded border-[#CBD5E1] focus:ring-[#2D6A4F]"
                />
