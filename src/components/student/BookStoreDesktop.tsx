...
export const BookStoreDesktop: React.FC = () => {
  ...
  const portalConfig = {
    academic: {
      ...
      icon: <GraduationCap className="w-5 h-5 text-[#4338CA]" />,
    ...
    fiction: {
      ...
      icon: <Sparkles className="w-5 h-5 text-[#BE123C]" />,
  ...
  return (
    <div className="space-y-6 max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-6 font-sans">
      ...
      <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-4 pb-4 border-b border-[#E2E8F0]">
        ...
        <div className="flex items-center gap-3">
          <button
            ...
            className="flex items-center gap-2 px-3.5 py-2 rounded-xl bg-white border border-[#CBD5E1] text-[#0F172A] hover:bg-[#F8FAFC] text-xs font-bold transition-all shadow-xs cursor-pointer"
          >
        ...
        <div className="flex flex-col md:flex-row md:items-center justify-between gap-4">
          ...
          <div className="relative flex-1 max-w-lg">
            ...
            <input
              ...
              className="w-full pl-9 pr-4 py-2.5 text-xs sm:text-sm bg-[#F8FAFC] border border-[#CBD5E1] rounded-xl focus:bg-white focus:outline-none focus:ring-2 focus:ring-[#2D6A4F]/30 focus:border-[#2D6A4F] text-[#0F172A]"
            />
            {searchQuery && (
              <button
                onClick={() => setSearchQuery('')}
                className="absolute right-3 top-1/2 -translate-y-1/2 text-xs text-[#64748B] hover:text-[#0F172A] bg-[#E2E8F0] px-1.5 py-0.5 rounded cursor-pointer"
              >
                Clear
              </button>
            )}
          ...
          <div className="flex items-center gap-3 flex-wrap">
            ...
            <div className="flex items-center gap-1.5 bg-[#F8FAFC] border border-[#CBD5E1] rounded-xl px-3 py-2">
              ...
              <select
                ...
                className="text-xs font-bold bg-transparent text-[#0F172A] focus:outline-none cursor-pointer"
              >
            ...
            <button
              ...
              className="flex items-center gap-1.5 px-3.5 py-2 bg-[#F8FAFC] hover:bg-[#E2E8F0] text-[#0F172A] text-xs font-bold rounded-xl border border-[#CBD5E1] transition-colors cursor-pointer"
            >
            ...
            <button
              ...
              className="flex items-center gap-1.5 px-4 py-2 bg-[#2D6A4F] hover:bg-[#22543D] active:scale-[0.98] text-white text-xs sm:text-sm font-bold rounded-xl shadow-md shadow-[#2D6A4F]/20 transition-all cursor-pointer whitespace-nowrap"
            >
        ...
        <div className="flex flex-col lg:flex-row lg:items-center justify-between gap-3 pt-3 border-t border-[#E2E8F0]">
          ...
          <div className="flex items-center gap-2 self-end lg:self-center">
            ...
            <select
              ...
              className="text-xs font-semibold bg-[#F8FAFC] border border-[#CBD5E1] rounded-xl px-3 py-1.5 text-[#0F172A] focus:outline-none cursor-pointer"
            >
      ...
      <div className="flex items-center justify-between text-xs text-[#64748B] px-1">
        <span>
          Showing <strong className="text-[#0F172A] font-bold">{filtered.length}</strong> books in {portalConfig.name}
        </span>
      ...
      {filtered.length === 0 ? (
        <div className="bg-white border border-[#E2E8F0] rounded-3xl p-12 text-center">
          ...
          <button
            onClick={() => setIsPurchaseModalOpen(true)}
            className="px-5 py-2.5 text-xs font-bold bg-[#2D6A4F] hover:bg-[#22543D] text-white rounded-xl shadow-md transition-colors cursor-pointer"
          >
