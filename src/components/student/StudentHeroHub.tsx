    ...
    <div className="space-y-8 max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8 font-sans">
      ...
      >
        <div>
          ...
          <h1 className="text-2xl sm:text-3xl font-black text-[#0F172A] tracking-tight mt-1">
            Welcome, <span className="text-[#2D6A4F]">{currentUser?.name}</span>
          </h1>
        ...
        <div className="flex items-center gap-2.5">
          <button
            ...
            className="flex items-center gap-1.5 px-3.5 py-2 bg-white hover:bg-[#F8FAFC] text-[#0F172A] text-xs font-bold rounded-xl border border-[#CBD5E1] transition-all shadow-xs cursor-pointer"
          >
          ...
          <button
            ...
            className="flex items-center gap-1.5 px-4 py-2 bg-[#2D6A4F] hover:bg-[#22543D] text-white text-xs font-bold rounded-xl shadow-md shadow-[#2D6A4F]/20 transition-all cursor-pointer"
          >
      ...
      >
        ...
        <motion.div
          ...
          className="group relative bg-white rounded-3xl p-7 border border-[#E2E8F0] hover:border-[#4338CA]/40 shadow-sm hover:shadow-2xl hover:shadow-[#4338CA]/10 transition-all duration-300 cursor-pointer flex flex-col justify-between overflow-hidden"
        >
          {/* Subtle warm animated ambient hue */}
          <div className="absolute top-0 right-0 w-64 h-64 bg-gradient-to-bl from-[#EEF2FF] to-transparent rounded-full blur-2xl pointer-events-none opacity-60 group-hover:opacity-100 transition-opacity" />

          <div className="space-y-4 relative z-10">
            <div className="flex items-center justify-between">
              <div className="w-12 h-12 rounded-2xl bg-[#EEF2FF] text-[#4338CA] flex items-center justify-center shadow-xs group-hover:scale-110 group-hover:rotate-3 transition-transform duration-300">
                <GraduationCap className="w-6 h-6" />
              </div>
              <span className="text-xs font-extrabold uppercase px-3 py-1 rounded-full bg-[#EEF2FF] text-[#4338CA] border border-[#C7D2FE]">
                {academicCount} Textbooks
              </span>
            </div>

            <div>
              <h3 className="text-xl font-black text-[#0F172A] tracking-tight group-hover:text-[#4338CA] transition-colors">
            ...
            <div className="flex flex-wrap gap-1.5 pt-2" onClick={(e) => e.stopPropagation()}>
              {['Chemistry', 'Physics', 'Biology', 'Mathematics', 'Computer Science', 'IB DP'].map((sub) => (
                <button
                  ...
                  className="text-[11px] font-bold px-2.5 py-1 rounded-lg bg-[#F8FAFC] hover:bg-[#EEF2FF] text-[#475569] hover:text-[#4338CA] border border-[#E2E8F0] transition-colors cursor-pointer"
                >
                  {sub}
                </button>
              ))}
          ...
          <div className="mt-6 pt-4 border-t border-[#F1F5F9] flex items-center justify-between text-xs font-bold text-[#4338CA] relative z-10">
        ...
        <motion.div
          ...
          className="group relative bg-white rounded-3xl p-7 border border-[#E2E8F0] hover:border-[#BE123C]/40 shadow-sm hover:shadow-2xl hover:shadow-[#BE123C]/10 transition-all duration-300 cursor-pointer flex flex-col justify-between overflow-hidden"
        >
          {/* Subtle warm animated ambient hue */}
          <div className="absolute top-0 right-0 w-64 h-64 bg-gradient-to-bl from-[#FFF1F2] to-transparent rounded-full blur-2xl pointer-events-none opacity-60 group-hover:opacity-100 transition-opacity" />

          <div className="space-y-4 relative z-10">
            <div className="flex items-center justify-between">
              <div className="w-12 h-12 rounded-2xl bg-[#FFF1F2] text-[#BE123C] flex items-center justify-center shadow-xs group-hover:scale-110 group-hover:rotate-3 transition-transform duration-300">
                <Sparkles className="w-6 h-6" />
              </div>
              <span className="text-xs font-extrabold uppercase px-3 py-1 rounded-full bg-[#FFF1F2] text-[#BE123C] border border-[#FECDD3]">
                {fictionCount} Titles
              </span>
            </div>

            <div>
              <h3 className="text-xl font-black text-[#0F172A] tracking-tight group-hover:text-[#BE123C] transition-colors">
                Fiction & Non-Fiction
              </h3>
              <p className="text-xs text-[#64748B] mt-1.5 leading-relaxed">
            ...
            <div className="flex flex-wrap gap-1.5 pt-2" onClick={(e) => e.stopPropagation()}>
              {['Percy Jackson (Parts 1-5)', 'Dune', '1984', 'Classics', 'Sci-Fi', 'Non-Fiction'].map((tag) => (
                <button
                  ...
                  className="text-[11px] font-bold px-2.5 py-1 rounded-lg bg-[#F8FAFC] hover:bg-[#FFF1F2] text-[#475569] hover:text-[#BE123C] border border-[#E2E8F0] transition-colors cursor-pointer"
                >
                  {tag}
                </button>
              ))}
          ...
          <div className="mt-6 pt-4 border-t border-[#F1F5F9] flex items-center justify-between text-xs font-bold text-[#BE123C] relative z-10">
        ...
        >
          ...
          <div className="space-y-4 relative z-10">
            ...
            <div>
              <h3 className="text-xl font-black text-[#0F172A] tracking-tight group-hover:text-[#B45309] transition-colors">
            ...
            <div className="bg-[#F8FAFC] p-3 rounded-2xl border border-[#E2E8F0] text-xs text-[#64748B] space-y-1">
              <div className="flex justify-between">
                ...
                <strong className="text-[#0F172A]">{myLogs.length} entries</strong>
              </div>
              <div className="flex justify-between">
        ...
        <motion.div
          ...
          className="group relative bg-white rounded-3xl p-7 border border-[#E2E8F0] hover:border-[#2D6A4F]/40 shadow-sm hover:shadow-2xl hover:shadow-[#2D6A4F]/10 transition-all duration-300 cursor-pointer flex flex-col justify-between overflow-hidden"
        >
          {/* Subtle warm animated ambient hue */}
          ...
          <div className="space-y-4 relative z-10">
            <div className="flex items-center justify-between">
              <div className="w-12 h-12 rounded-2xl bg-[#EBF5EE] text-[#2D6A4F] flex items-center justify-center shadow-xs group-hover:scale-110 group-hover:rotate-3 transition-transform duration-300">
                <BookmarkCheck className="w-6 h-6" />
              </div>
              <span className="text-xs font-extrabold uppercase px-3 py-1 rounded-full bg-[#EBF5EE] text-[#2D6A4F] border border-[#2D6A4F]/20">
                {studentLoans.length} Active Loans
              </span>
            </div>

            <div>
              <h3 className="text-xl font-black text-[#0F172A] tracking-tight group-hover:text-[#2D6A4F] transition-colors">
            ...
            <div className="bg-[#F8FAFC] p-3 rounded-2xl border border-[#E2E8F0] text-xs text-[#64748B] space-y-1">
              <div className="flex justify-between">
                ...
                <strong className="text-[#0F172A]">{waitlist.filter((w) => w.studentEmail === currentUser?.email && w.status === 'waiting').length} waitlists</strong>
              </div>
              <div className="flex justify-between">
                <span>Acquisition Requests:</span>
                <strong className="text-[#2D6A4F]">Active Review</strong>
              </div>
            </div>
          </div>

          <div className="mt-6 pt-4 border-t border-[#F1F5F9] flex items-center justify-between text-xs font-bold text-[#2D6A4F] relative z-10">
